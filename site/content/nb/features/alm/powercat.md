...
Vår interne prosess har et Power Platform miljø for utvikling, test og produksjon. Når vi er klare for en utgivelse, pakker våre integrerte GitHub-handlinger de administrerte og uadministrerte distribusjonsløsningene sammen med produktmerknader automatisk for en GitHub Draft-utgivelse.
...
Samlet sett bygger vi videre på de eksisterende Power Platform og Microsoft DevOps-produktfunksjonene sammen ALM Accelerator. Denne kombinasjonen lar oss fokusere på spesifikke utvidelser som hjelper med hyperautomtion.
...
Hver utgivelse fremmer endringer fra utviklingen vår til test- og produksjonsmiljøer. De Power Platform løsningene i settet bruker en automatisert prosess for å pakke ressurser for distribusjon til offentlige GitHub-utgivelser.
...
3. Når pull-forespørselen har bestått de automatiserte kontrollene og mottatt godkjenningen for gjennomgang, kan den slås sammen til hovedgrenen. Denne flettingen utløser testdatasamlebåndet for Azure DevOps-kompilering, som publiserer den administrerte versjonen til testmiljøet Power Platform.

4. Etter intern testing utløses Azure DevOps-produksjonspipelinen manuelt for å generere en Production Power Platform-distribusjon.
