...
namespace PowerCAT.PackageDeployer.Package
{
    ...
    public class PackageImportExtension : ImportExtension
    {
        ...
        public override string GetNameOfImport(bool plural) => "PowerCAT.PackageDeployer.Package";
        ...
        /// </summary>
        public override string GetImportPackageDescriptionText => "PowerCAT.PackageDeployer.Package";
